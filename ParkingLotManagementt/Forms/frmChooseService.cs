...
{
    public partial class frmChooseService : Form
    {
        private string type;
        ...
        private void loadService ()
        {
            ...
            {
                flowServiceForCar.Controls.Add(new UC_Controls.UC_Service(service));
            }
            cbServiceRent.DataSource = service_ThueMuon;
            cbServiceRent.DisplayMember = "nameService";
        }
        public frmChooseService()
        {
            InitializeComponent();
            Region = Region.FromHrgn(CreateRoundRectRgn(0, 0, Width, Height, 20, 20));
        }
        public frmChooseService(string type)
        {
            InitializeComponent();
            Region = Region.FromHrgn(CreateRoundRectRgn(0, 0, Width, Height, 20, 20));
            this.type = type;
        ...
        private void btnApply_Click(object sender, EventArgs e)
        {
            ...
            foreach (UC_Controls.UC_Service control in flowServiceForCar.Controls)
            {
                if (control.Checked())
                {
            ...
            // nếu khách hàng lựa chọn thêm dịch vụ cho thuê xe thì tiến hành thêm
